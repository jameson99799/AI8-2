...
import { delay, getErrorMessage as getErrorMessage2, isAbortError } from "@ai-sdk/provider-utils";
...
import { AISDKError as AISDKError8, getErrorMessage as getErrorMessage3 } from "@ai-sdk/provider";
...
var InvalidToolInputError = class extends AISDKError8 {
  constructor({
    ...
    toolName,
    cause,
    message = `Invalid input for tool ${toolName}: ${getErrorMessage3(cause)}`
  }) {
